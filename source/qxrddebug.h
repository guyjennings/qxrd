...
enum {
  ...
  DEBUG_ACQUIRETIME = (DEBUG_BROWSER + 1),
  DEBUG_INTEGRATOR  = (DEBUG_ACQUIRETIME + 1),
  DEBUG_TRIGGER     = (DEBUG_INTEGRATOR + 1),
  DEBUG_EXTRAINPUTS = (DEBUG_TRIGGER + 1),
  DEBUG_LOGSCRIPTS  = (DEBUG_EXTRAINPUTS + 1),
  DEBUG_PLUGINS     = (DEBUG_LOGSCRIPTS + 1),
  DEBUG_FITTING     = (DEBUG_PLUGINS + 1),
  DEBUG_NOPARALLEL  = (DEBUG_FITTING + 1),
  DEBUG_HISTOGRAM   = (DEBUG_NOPARALLEL + 1),
  DEBUG_CALIBRANT   = (DEBUG_HISTOGRAM + 1),
  DEBUG_DATABROWSER = (DEBUG_CALIBRANT + 1),
