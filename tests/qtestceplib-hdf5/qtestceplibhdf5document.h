#ifndef QTESTCEPLIBHDF5DOCUMENT_H
#define QTESTCEPLIBHDF5DOCUMENT_H
...
class QtestceplibHdf5Document : public QcepSerializableObject
{
  Q_OBJECT

public:
  QtestceplibHdf5Document();
...
#endif // QTESTCEPLIBHDF5DOCUMENT_H
