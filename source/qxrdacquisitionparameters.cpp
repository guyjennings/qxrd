...
QxrdAcquisitionParameters::QxrdAcquisitionParameters(DetectorKind detectorKind, QxrdSettingsSaverWPtr saver)
  : QObject(),
    m_Saver(saver),
    m_QxrdVersion(saver, this,"qxrdVersion",STR(QXRD_VERSION), "QXRD Version Number"),
    m_QtVersion(saver, this,"qtVersion",qVersion(), "QT Version Number"),
    m_DetectorType(saver, this, "detectorType", detectorKind, "Detector Type (0 = simulated, 1 = PE, 2 = Pilatus, 3 = EPICS, 4 = Files)"),
    m_DetectorTypeName(saver, this,"detectorTypeName", detectorKindName(detectorKind), "Name of Detector Type"),
    ...
    m_AcquireDark(saver, this, "acquireDark", 0, "Acquire Dark Image?"),
