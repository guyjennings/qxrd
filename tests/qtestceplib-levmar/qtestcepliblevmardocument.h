#ifndef QTESTCEPLIBLEVMARDOCUMENT_H
#define QTESTCEPLIBLEVMARDOCUMENT_H
...
class QtestceplibLevMarDocument : public QcepSerializableObject
{
  Q_OBJECT

public:
  QtestceplibLevMarDocument();
...
#endif // QTESTCEPLIBLEVMARDOCUMENT_H
