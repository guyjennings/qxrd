...
QxrdIntegrator::QxrdIntegrator(QString name)
  : inherited(name),
    ...
    m_IntegrationMinimum(this, "integrationMinimum", 0, "Integration Minimum"),
    m_IntegrationMaximum(this, "integrationMaximum", 100, "Integration Maximum"),
    m_IntegrationXUnits(this, "integrationXUnits", RadialIntegrateTTH, "X Units for Integration (0 = TTH, 1 = Q, 2 = R)"),
    ...
    m_EnableAbsorptionCorrections(this, "enableAbsorptionCorrections", false, "Enable Absorption Correction in Integration"),
    m_AttenuationLength(this, "attenuationLength", 0, "Attenuation Length (mm)"),
    m_EnableUserGeometry(this, "enableUserGeometry", 0, "Apply user-defined geometry function in integration"),
    m_UserGeometryScript(this, "userGeometryScript", defaultUserGeometryScript(), "Script to define user defined geometry functions"),
    m_UserGeometryFunction(this, "userGeometryFunction", "userGeometry", "Name of user defined geometry function"),
    m_EnableUserAbsorption(this, "enableUserAbsorption", 0, "Apply user-defined geometry function in integration"),
    m_UserAbsorptionScript(this, "userAbsorptionScript", defaultUserAbsorptionScript(), "Script to define user defined absorption functions"),
    m_UserAbsorptionFunction(this, "userAbsorptionFunction", "userAbsorb1", "Name of user defined absorption function"),
    m_ScalingFactor(this, "scalingFactor", 1.0, "Scaling factor for integrated intensity"),
