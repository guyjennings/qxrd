...
QcepImageDataBase::QcepImageDataBase(QxrdSettingsSaverPtr saver, int width, int height)
  : QObject(),
    ...
    m_DataType(saver, this, "dataType", UndefinedData),
    m_FileBase(saver, this, "fileBase", ""),
    m_FileName(saver, this, "fileName", ""),
    m_Title(saver, this, "title", ""),
    m_ReadoutMode(saver, this, "readoutMode", 0),
    m_ExposureTime(saver, this, "exposureTime", 0),
    m_SummedExposures(saver, this, "summedExposures", 0),
    m_ImageNumber(saver, this, "imageNumber", 0),
    m_PhaseNumber(saver, this, "phaseNumber", -1),
    m_NPhases(saver, this, "nPhases", -1),
    m_DateTime(saver, this, "dateTime", QDateTime::currentDateTime()),
    m_HBinning(saver, this, "hBinning", 1),
    m_VBinning(saver, this, "vBinning", 1),
