#ifndef QTESTCEPLIBTIFFDOCUMENT_H
#define QTESTCEPLIBTIFFDOCUMENT_H
...
class QtestceplibTiffDocument : public QcepSerializableObject
{
  Q_OBJECT

public:
  QtestceplibTiffDocument();
...
#endif // QTESTCEPLIBTIFFDOCUMENT_H
