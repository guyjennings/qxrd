...
QxrdAcquisitionParameters::QxrdAcquisitionParameters(DetectorKind detectorKind, QxrdSettingsSaverWPtr saver)
  : QObject(),
    m_Saver(saver),
    m_QxrdVersion(QxrdSettingsSaverPtr(), this,"qxrdVersion",STR(QXRD_VERSION)),
    m_QtVersion(QxrdSettingsSaverPtr(), this,"qtVersion",qVersion()),
    m_DetectorType(QxrdSettingsSaverPtr(), this, "detectorType", detectorKind),
    m_DetectorTypeName(QxrdSettingsSaverPtr(), this,"detectorTypeName", detectorKindName(detectorKind)),
    m_ExposureTime(saver, this,"exposureTime",0.1),
    m_SkippedExposuresAtStart(saver, this,"skippedExposuresAtStart",0),
    m_LastAcquired(QxrdSettingsSaverPtr(), this, "lastAcquired", 0),
    ...
    m_AcquireDark(QxrdSettingsSaverPtr(), this, "acquireDark", 0),
