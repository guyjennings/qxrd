...
QxrdPlotWidgetDialog::QxrdPlotWidgetDialog(QWidget *parent,
                                     QxrdPlotWidgetSettingsWPtr settings) :
    QDialog(parent),
    m_Settings(settings)
{
  if (qcepDebug(DEBUG_CONSTRUCTORS)) {
    printf("QxrdPlotWidgetDialog::QxrdPlotWidgetDialog(%p)\n", this);
  }
...
QxrdPlotWidgetDialog::~QxrdPlotWidgetDialog()
{
  if (qcepDebug(DEBUG_CONSTRUCTORS)) {
    printf("QxrdPlotWidgetDialog::~QxrdPlotWidgetDialog(%p)\n", this);
  }
...
void QxrdPlotWidgetDialog::changeEvent(QEvent *e)
{
...
void QxrdPlotWidgetDialog::accept()
{
  QDialog::accept();
