 ...
 *   yPhysical = y_d
 */
void QxrdDetectorGeometry::getTwoThetaChi(double xCenter,double yCenter,
                                          double distance,double xPixel,double yPixel,
                                          double pixelLength,double pixelHeight,
...
void QxrdDetectorGeometry::getQChi(double xCenter,double yCenter,double distance,
 ...
 *   yPhysical = y_d
 */
void QxrdDetectorGeometry::getXY(double xCenter,double yCenter,double distance,
