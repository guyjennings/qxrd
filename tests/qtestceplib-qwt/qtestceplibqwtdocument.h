#ifndef QTESTCEPLIBQWTDOCUMENT_H
#define QTESTCEPLIBQWTDOCUMENT_H
...
class QtestceplibQwtDocument : public QcepSerializableObject
{
public:
  QtestceplibQwtDocument();
...
#endif // QTESTCEPLIBQWTDOCUMENT_H
