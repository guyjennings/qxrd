#ifndef QTESTCEPLIBMAR345DOCUMENT_H
#define QTESTCEPLIBMAR345DOCUMENT_H
...
class QtestceplibMar345Document : public QcepSerializableObject
{
  Q_OBJECT

public:
  QtestceplibMar345Document();
...
#endif // QTESTCEPLIBMAR345DOCUMENT_H
