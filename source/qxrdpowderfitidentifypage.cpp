  ...
  m_SampledData()
{
  ...
  if (dp) {
    m_SampledData = dp->initialRingSetData();
  }
...
void QxrdPowderFitIdentifyPage::idPerformFit()
{
  ...
  if (dp) {
    QxrdRingSetFitParametersPtr p = dp->initialRingSetFitParameters();
...
void QxrdPowderFitIdentifyPage::evaluateFit(double *parm, double *x, int np, int /*nx*/)
{
  ...
  if (dp) {
    ...
    QxrdRingSetFitParametersPtr pf = dp->initialRingSetFitParameters();
