...
public:
  ...
  explicit QxrdPowderPointProperty(QcepSettingsSaverWPtr saver, QObject *parent, const char *name, int n1, int n2, int n3, double x, double y, double r1, double r2, double az, QString toolTip);
