...
#define DETEKTOR_18BIT_DATATYPE unsigned int
#define DETEKTOR_18BIT_DATATYPESIZE 4
#define DETEKTOR_16BIT_DATATYPE unsigned short
#define DETEKTOR_16BIT_DATATYPESIZE 2
