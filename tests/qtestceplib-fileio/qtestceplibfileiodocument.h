#ifndef QTESTCEPLIBFILEIODOCUMENT_H
#define QTESTCEPLIBFILEIODOCUMENT_H
...
class QtestceplibFileIODocument : public QcepSerializableObject
{
  Q_OBJECT

public:
  QtestceplibFileIODocument();
...
#endif // QTESTCEPLIBFILEIODOCUMENT_H
