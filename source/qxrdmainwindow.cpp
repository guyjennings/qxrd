...
QxrdMainWindow::QxrdMainWindow(QWidget *parent) : QMainWindow(parent)
{

}

void QxrdMainWindow::possiblyClose()
{
...
bool QxrdMainWindow::wantToClose()
{
  THREAD_CHECK;
...
void QxrdMainWindow::setFontSize(int fontSize)
{
...
void QxrdMainWindow::setSpacing(int spacing)
{
  if (QThread::currentThread()==thread()) {
...
void QxrdMainWindow::setObjectSpacing(QObject *obj, int spacing)
{
...
void QxrdMainWindow::shrinkPanels(int fontSize, int spacing)
{
//  if (QThread::currentThread()==thread()) {
...
void QxrdMainWindow::shrinkDockWidget(QDockWidget *dw, int fontSize, int spacing)
{
  shrinkObject(dw, fontSize, spacing);
}

void QxrdMainWindow::shrinkObject(QObject *obj, int fontSize, int spacing)
{
  if (obj) {
