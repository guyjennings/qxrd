#ifndef QTESTCEPLIBCBFDOCUMENT_H
#define QTESTCEPLIBCBFDOCUMENT_H
...
class QtestceplibCbfDocument : public QcepSerializableObject
{
  Q_OBJECT

public:
  QtestceplibCbfDocument();
...
#endif // QTESTCEPLIBCBFDOCUMENT_H
