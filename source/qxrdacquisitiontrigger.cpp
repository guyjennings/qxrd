...
QxrdAcquisitionTrigger::QxrdAcquisitionTrigger(QxrdSettingsSaverPtr saver, QxrdExperimentWPtr expt, QxrdAcquisitionWPtr acq) :
  ...
  m_TriggerAValue(saver, this,"triggerAValue", 0),
  m_TriggerAPrevValue(saver, this,"triggerAPrevValue", 0),
  ...
  m_TriggerBValue(saver, this,"triggerBValue", 0),
  m_TriggerBPrevValue(saver, this,"triggerBPrevValue", 0),
  m_Experiment(expt),
  m_Acquisition(acq),
  m_NIDAQPlugin(NULL)
{
