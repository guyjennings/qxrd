...
QxrdIntegratorCache::QxrdIntegratorCache(QxrdExperimentWPtr exp, QxrdAllocatorWPtr alloc) :
  ...
  m_IntegrationMinimum(QxrdSettingsSaverPtr(), this, "integrationMinimum", 0),
  m_IntegrationMaximum(QxrdSettingsSaverPtr(), this, "integrationMaximum", 100000),
  m_IntegrationXUnits(QxrdSettingsSaverPtr(), this, "integrationXUnits", QxrdIntegrator::IntegrateTTH),
  m_CenterX(QxrdSettingsSaverPtr(), this, "centerX", 0),
  m_CenterY(QxrdSettingsSaverPtr(), this, "centerY", 0),
  m_CenterStep(QxrdSettingsSaverPtr(), this, "centerStep", 1),
  m_DetectorXPixelSize(QxrdSettingsSaverPtr(), this, "detectorXPixelSize", 200),
  m_DetectorYPixelSize(QxrdSettingsSaverPtr(), this, "detectorYPixelSize", 200),
  m_DetectorDistance(QxrdSettingsSaverPtr(), this, "detectorDistance", 1000),
  m_Energy(QxrdSettingsSaverPtr(), this, "energy", 20000),
  m_ImplementTilt(QxrdSettingsSaverPtr(), this,"implementTilt", false),
  m_DetectorTilt(QxrdSettingsSaverPtr(), this, "detectorTilt", 0),
  m_TiltPlaneRotation(QxrdSettingsSaverPtr(), this, "tiltPlaneRotation", 90),
  m_NRows(QxrdSettingsSaverPtr(), this, "nRows", -1),
  m_NCols(QxrdSettingsSaverPtr(), this, "nCols", -1),
  m_RStep(QxrdSettingsSaverPtr(), this, "rStep", 0),
  m_RMin(QxrdSettingsSaverPtr(), this, "rMin", 0),
  m_RMax(QxrdSettingsSaverPtr(), this, "rMax", 0),
  m_NMin(QxrdSettingsSaverPtr(), this, "nMin", 0),
  m_NMax(QxrdSettingsSaverPtr(), this, "nMax", 0),
  m_NRange(QxrdSettingsSaverPtr(), this, "nRange", 0),
  m_Beta(QxrdSettingsSaverPtr(), this, "beta", 0),
  m_CosBeta(QxrdSettingsSaverPtr(), this, "cosBeta", 1),
  m_SinBeta(QxrdSettingsSaverPtr(), this, "sinBeta", 0),
  m_Rot(QxrdSettingsSaverPtr(), this, "rot", 0),
  m_CosRot(QxrdSettingsSaverPtr(), this, "cosRot", 0),
  m_SinRot(QxrdSettingsSaverPtr(), this, "sinRot", 0),
  m_CacheFillLevel(-1),
  m_CacheFullLevel(-1),
  m_Experiment(exp),
  m_Allocator(alloc)
